...
public class addstock extends AppCompatActivity {
    ...
    public String bind(String input)
    {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewstock = (Button)findViewById(R.id.view);
        ...
        addstock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String wforen = bind(whprice);
                String tforen = bind(total);
                String enwhprice = encrypt(wforen,key);
                String entotal = encrypt(tforen,key);

                storestocks(id,pname,cusprice,enwhprice,entotal);
            }
        });
    ...
    private void storestocks(String id,String pname,String cusprice,String enwhprice,String entotal)
    {
         if(!pname.isEmpty() && !cusprice.isEmpty() && !enwhprice.isEmpty() && !entotal.isEmpty())
         {
             ...
             db.collection("stockslist").document(id).set(map)
                     .addOnCompleteListener(new OnCompleteListener<Void>() {
                         @Override
                         public void onComplete(@NonNull Task<Void> task) {
                             if(task.isSuccessful())
                             {
                                 Toast.makeText(addstock.this, "Products Added !!", Toast.LENGTH_SHORT).show();
                             }
                         }
                     }).addOnFailureListener(new OnFailureListener() {
                 @Override
                 public void onFailure(@NonNull Exception e) {
                     Toast.makeText(addstock.this, "Failed to add products !!", Toast.LENGTH_SHORT).show();
                 }
             });
         }
         else
         {
             Toast.makeText(addstock.this, "Empty fields not allowed !!", Toast.LENGTH_SHORT).show();
         }
    }
}
